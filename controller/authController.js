...
exports.register = async (req, res) => {
    try {
        const {username, idade, loginuser, celular, password} = req.body;
        ...
        const user = await User.create({username, idade, loginuser, celular, password: hashedPassword, active: true});
